...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 04, 2020 at 11:04 AM
...
CREATE TABLE `flats` (
  ...
  `full address` varchar(300) NOT NULL,
...
INSERT INTO `flats` (`id`, `owner name`, `mobile no`, `flattype`, `full address`, `area`, `rent`) VALUES
